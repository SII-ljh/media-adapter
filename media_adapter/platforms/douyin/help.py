...
from media_adapter.models.m_douyin import VideoUrlInfo, CreatorUrlInfo
from media_adapter.resources import get_douyin_js_content
from media_adapter.utils.crawler_util import extract_url_params_to_dict

douyin_sign_obj = execjs.compile(get_douyin_js_content())

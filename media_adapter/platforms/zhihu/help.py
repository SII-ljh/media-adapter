...
from media_adapter.resources import get_zhihu_js_content
from media_adapter.utils import utils
from media_adapter.utils.crawler_util import extract_text_from_html
...
def sign(url: str, cookies: str) -> Dict:
    ...
    if not ZHIHU_SGIN_JS:
        ZHIHU_SGIN_JS = execjs.compile(get_zhihu_js_content())

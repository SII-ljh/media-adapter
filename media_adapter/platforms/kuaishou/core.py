...
from media_adapter.core.base_crawler import AbstractCrawler
from media_adapter.models.m_kuaishou import VideoUrlInfo, CreatorUrlInfo
from media_adapter.proxy.proxy_ip_pool import IpInfoModel, create_ip_pool
from media_adapter.storage import kuaishou as kuaishou_store
from media_adapter.utils import utils
from media_adapter.utils.cdp_browser import CDPBrowserManager
from media_adapter.context import comment_tasks_var, crawler_type_var, source_keyword_var
    ...
    async def start(self):
        ...
        async with async_playwright() as playwright:
            ...
            if config.ENABLE_CDP_MODE:
                ...
                await self.browser_context.add_init_script(path=get_stealth_js_path())
